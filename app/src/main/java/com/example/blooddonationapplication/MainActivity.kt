...
class MainActivity : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.nav_event, R.id.nav_user_account, R.id.nav_user_activity,
                R.id.nav_user_notification, R.id.nav_organizer_activity, R.id.nav_organizer_notification
            ), drawerLayout
        )
            ...
            ref.collection("Users").document(currentuser?.uid)
                ...
                .addOnSuccessListener { documentSnapshot ->
                    if(documentSnapshot.exists()){
                        if(documentSnapshot.get("Type").toString() =="Donor"){
                            val userNavigate = drawer.setGroupVisible(R.id.donor_navigate,true)
                            ...
                            val userNavigate = drawer.setGroupVisible(R.id.donor_navigate,false)
